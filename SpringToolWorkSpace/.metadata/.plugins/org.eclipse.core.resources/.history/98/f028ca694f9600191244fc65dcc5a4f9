...
public class ShowParams extends HttpServlet {
	...
	public String checkLogin(HttpServletRequest request) {
		...
		if((request.getParameter("email").toLowerCase().equals("admin@gmail.com") && 
				request.getParameter("pass").toLowerCase().equals("admin123456")) || 
				(request.getParameter("email").toLowerCase().equals("thiinhpham123@gmail.com") && 
						request.getParameter("pass").toLowerCase().equals("1234567890"))) {
